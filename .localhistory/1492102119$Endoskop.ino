...
void loop()
{
	...
	/*if (!stepper1.isRunning())
	{
		...
		if (joystick.getCurrentHorizontalDirection() == HorizontalDirection::HOR_LEFT)
		{
			stepper1.setForwardMovement(1, 500);
		}
		else if (joystick.getCurrentHorizontalDirection() == HorizontalDirection::HOR_RIGHT)
		{
			stepper1.setBackwardMovement(1, 500);
		}
	}*/
